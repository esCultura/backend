...
from .views import PerfilView, OrganitzadorView, AdmistradorView, SignUpPerfilsView, SignUpOrganitzadorsView, SignUpAdminsView, LoginPerfilsView, LoginOrganitzadorsView, LoginAdminView, GoogleSignIn
